...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock,mCenterClock, mNetworkTraffic, mBeltzLogo;
    ...
    public void init() {
        ...
        mBeltzLogo = mView.findViewById(R.id.beltz_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mBeltzLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mBeltzLogo.setAlpha(newAlphaBC);
        }
    }
}
